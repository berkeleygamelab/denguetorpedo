...
b1 = Prize.create!(:prize_name => "De olho no mosquito", :cost => 50, :stock => -1, :user_id => 1, :description => "Carimbo digital", :redemption_directions => "None! Just redeem with points and you will get your badge right away!", :prize_photo => File.open(File.join(Rails.root,'/app/assets/images/badges/orange_star.fw.png')), :is_badge => true)
b2 = Prize.create!(:prize_name => "Extermindaor de mosquitos", :cost => 100, :stock => -1, :user_id => 1, :description => "Adesivo pequeno Carimbo digital", :redemption_directions => "None! Just redeem with points and you will get your badge right away!", :prize_photo => File.open(File.join(Rails.root,'/app/assets/images/badges/blue_black_star.fw.png')), :is_badge => true)
b3 = Prize.create!(:prize_name => "Guerreiro DT", :cost => 200, :stock => -1, :user_id => 1, :description => "Adesivo grande Carimbo digital", :redemption_directions => "None! Just redeem with points and you will get your badge right away!", :prize_photo => File.open(File.join(Rails.root,'/app/assets/images/badges/orange_black_star.fw.png')), :is_badge => true)
b4 = Prize.create!(:prize_name => "Comunidade Saudavel", :cost => 500, :stock => -1, :user_id => 1, :description => "Camiseta Adesivo Carimbo digital", :redemption_directions => "None! Just redeem with points and you will get your badge right away!", :prize_photo => File.open(File.join(Rails.root,'/app/assets/images/badges/blue_star.fw.png')), :is_badge => true)
b5 = Prize.create!(:prize_name => "Eu cuido da Comunidade", :cost => 1000, :stock => -1, :user_id => 1, :description => "Honrarias Camiseta Adesivo Carimbo digital", :redemption_directions => "None! Just redeem with points and you will get your badge right away!", :prize_photo => File.open(File.join(Rails.root,'/app/assets/images/badges/golden_star.fw.png')), :is_badge => true)
